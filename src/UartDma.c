...
*
*******************************************************************************/
void configure_rx_dma(uint8_t* buffer, cy_stc_sysint_t* int_config)
{
    ...
    Cy_DMA_Descriptor_SetSrcAddress(&RxDma_Descriptor_0, (uint32_t *) &UART_RECEIVER_HW->RX_FIFO_RD);
    Cy_DMA_Descriptor_SetDstAddress(&RxDma_Descriptor_0, (uint32_t *) buffer);
...
void configure_tx_dma(uint8_t* buffer_a, cy_stc_sysint_t* int_config)
{
    ...
    Cy_DMA_Descriptor_SetDstAddress(&TxDma_Descriptor_0, (uint32_t *) &UART_RECEIVER_HW->TX_FIFO_WR);
